...
<head>
    ...
    <title><?php echo $title ?? 'App\Modules\Product'; ?> - Enhanced upMVC</title>
    ...
    <!-- Enhanced Module CSS -->
    <link rel="stylesheet" href="<?php echo BASE_URL ?? ''; ?>/src/Modules/Product/assets/css/style.css">
        ...
        <div class="container">
            ...
            <div class="navbar-nav ms-auto">
                <a class="nav-link" href="<?php echo BASE_URL ?? ''; ?>/product">
                    <i class="fas fa-home"></i> App\Modules\Product
                </a>
                <a class="nav-link" href="<?php echo BASE_URL ?? ''; ?>/product/about">
                    <i class="fas fa-info-circle"></i> About
                </a>
                <?php if ($debug_mode ?? false): ?>
                <a class="nav-link" href="<?php echo BASE_URL ?? ''; ?>/product/api">
