/**
 * Enhanced App\Modules\TestBlog Module JavaScript
 * Auto-discovery enabled, environment-aware
 */

class EnhancedApp\Modules\TestBlogModule {
    constructor() {
        this.moduleName = 'App\Modules\TestBlog';
...
document.addEventListener('DOMContentLoaded', function() {
    window.enhancedApp\Modules\TestBlog = new EnhancedApp\Modules\TestBlogModule();
});

// Export for external use
window.EnhancedApp\Modules\TestBlogModule = EnhancedApp\Modules\TestBlogModule;