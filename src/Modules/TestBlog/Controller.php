<?php
namespace App\Modules\TestBlog;

use App\Common\Bmvc\BaseController;

/**
 * Enhanced App\Modules\TestBlog Controller
 * 
...
class Controller extends BaseController
{
    ...
    {
        $data = [
            'title' => 'App\Modules\TestBlog Module',
            'message' => 'Welcome to the enhanced App\Modules\TestBlog module!',
            'features' => [
    ...
    {
        $data = [
            'title' => 'About App\Modules\TestBlog',
