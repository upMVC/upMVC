/**
 * Enhanced App\Modules\TestCrud Module JavaScript
 * Auto-discovery enabled, environment-aware
 */

class EnhancedApp\Modules\TestCrudModule {
    constructor() {
        this.moduleName = 'App\Modules\TestCrud';
...
document.addEventListener('DOMContentLoaded', function() {
    window.enhancedApp\Modules\TestCrud = new EnhancedApp\Modules\TestCrudModule();
});

// Export for external use
window.EnhancedApp\Modules\TestCrudModule = EnhancedApp\Modules\TestCrudModule;