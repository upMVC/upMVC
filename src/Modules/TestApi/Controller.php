<?php
namespace App\Modules\TestApi;

use App\Common\Bmvc\BaseController;

/**
 * Enhanced App\Modules\TestApi Controller
 * 
...
class Controller extends BaseController
{
    ...
    {
        $data = [
            'title' => 'App\Modules\TestApi Module',
            'message' => 'Welcome to the enhanced App\Modules\TestApi module!',
            'features' => [
    ...
    {
        $data = [
            'title' => 'About App\Modules\TestApi',
