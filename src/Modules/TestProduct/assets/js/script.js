/**
 * Enhanced App\Modules\TestProduct Module JavaScript
 * Auto-discovery enabled, environment-aware
 */

class EnhancedApp\Modules\TestProductModule {
    constructor() {
        this.moduleName = 'App\Modules\TestProduct';
...
document.addEventListener('DOMContentLoaded', function() {
    window.enhancedApp\Modules\TestProduct = new EnhancedApp\Modules\TestProductModule();
});

// Export for external use
window.EnhancedApp\Modules\TestProductModule = EnhancedApp\Modules\TestProductModule;