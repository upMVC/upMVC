...
/**
 * Enhanced App\Modules\TestBasic Controller
 * 
...
class Controller extends BaseController
{
    ...
    {
        $data = [
            'title' => 'App\Modules\TestBasic Module',
            'message' => 'Welcome to the enhanced App\Modules\TestBasic module!',
            'features' => [
    ...
    {
        $data = [
            'title' => 'About App\Modules\TestBasic',
