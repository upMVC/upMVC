<?php
namespace App\Modules\TestParent;

use App\Common\Bmvc\BaseController;

/**
 * Enhanced App\Modules\TestParent Controller
 * 
...
class Controller extends BaseController
{
    ...
    {
        $data = [
            'title' => 'App\Modules\TestParent Module',
            'message' => 'Welcome to the enhanced App\Modules\TestParent module!',
            'features' => [
    ...
    {
        $data = [
            'title' => 'About App\Modules\TestParent',
