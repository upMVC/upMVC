<?php
namespace App\Modules\TestAuth;

use App\Common\Bmvc\BaseController;

/**
 * Enhanced App\Modules\TestAuth Controller
 * 
...
class Controller extends BaseController
{
    ...
    {
        $data = [
            'title' => 'App\Modules\TestAuth Module',
            'message' => 'Welcome to the enhanced App\Modules\TestAuth module!',
            'features' => [
    ...
    {
        $data = [
            'title' => 'About App\Modules\TestAuth',
