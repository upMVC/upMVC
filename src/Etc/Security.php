...
class Security
{
     ...
     * 
    /**
     * Rate limit requests by identifier using file-based persistent storage.
     *
     * Counts attempts in a sliding time window. State is written to
     * storage/rate-limits/ so it survives across PHP-FPM requests and
     * server restarts — unlike the previous in-memory static array.
     *
     * Backward-compatible signature with the old in-memory version.
     *
