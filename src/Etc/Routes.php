...
class Routes
{
    ...
    private function registerRoutes(): void
    {
        ...
        // Load package module routes first, then app routes so local modules can override packs.
        foreach (Application::getInstance()->getModulePathsForRoutes() as $modulesPath) {
